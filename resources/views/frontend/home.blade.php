                        ...
                        @foreach ($lastFivePosts as $post)
                            <div class="position-relative overflow-hidden" style="height: 435px;">
                                ...
                                <div class="overlay">
                                    <div class="mb-1">
                                        <a class="text-white"
                                            href="{{ Route('category.frontend', $post->category->id) }}">{{ $post->category->title }}</a>
                                        <span class="px-2 text-white">/</span>
                                        <a class="text-white"
                                            href="{{ Route('post', $post->id) }}">{{ $post->created_at->format('Y,m,d') }}</a>
                                    </div>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                        ...
                        <a class="text-secondary font-weight-medium text-decoration-none"
                            href="#">{{ __('words.all categories') }}</a>
                    </div>
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="overlay position-relative bg-light">
                                            <div class="mb-2" style="font-size: 13px;">
                                                <a
                                                    href="{{ Route('category.frontend', $category->id) }}">{{ $category->title }}</a>
