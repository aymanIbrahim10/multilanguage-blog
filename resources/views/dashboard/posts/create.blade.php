...
@section('title', __('words.posts') . ' | ' . __('words.post add'))
@section('content')
    <!-- Main content -->
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('words.post add') }}</li>
        </ol>
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <img id="file-ip-1-preview" src="{{ asset('dashboard/img/default/default.png') }}" alt="{{ __('words.post image') }}"
                                        style="
                                    height: 100px;
                                    width: 100px;
                                    border-radius: 8px;
                                    ...
                                    @foreach (config('app.avaiable_lang') as $key => $lang)
                                        <div class="tab-pane fade show @if ($loop->index == 0) active in @endif"
                                            ...
                                            <div class="form-group mt-2 col-md-12">
                                                ...
                                                <textarea name="content:{{ $key }}" class="form-control" id="editor" cols="50" rows="10"></textarea>
                                                <span class="help-block text-danger">
                                                    @error('content:' . $key)
                                                        {{ __($message) }}
                                                    @enderror
                                            ...
                                            <div class="form-group mt-2 col-md-12">
                                                ...
                                                <textarea name="smallDesc:{{ $key }}" class="form-control" id="editor" cols="50" rows="10"></textarea>
                                                <span class="help-block text-danger">
                                                    @error('smallDesc:' . $key)
                                                        {{ __($message) }}
                                                    @enderror
